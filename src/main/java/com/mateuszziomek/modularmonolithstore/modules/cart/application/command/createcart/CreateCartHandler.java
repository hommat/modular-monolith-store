...
public class CreateCartHandler implements ReactiveCommandHandler<CreateCartCommand> {
    ...
    @Override
    public Mono<Try<Void>> handle(final CreateCartCommand command) {
